    ...
    const labels = ['January', 'February', 'March', 'April', 'May', 'June', 'July'];
     ...
     const data = {
      ...
      datasets: [
        ...
        {
          label: 'Dataset 2',
          data: [133,323,3333,5555,6,3337,8,],
...
{sessionStorage.getItem("name")?console.log("yes"):navigate("/login")}
          <div className={styles.upper_box}>
                ...
                <div className={styles.right_side}>
                    <h2 className={styles.change_data}>{location.state.change}</h2>
    ...
    {close => (
      <div className={styles.modal}>
        ...
        <div className={styles.content}>
          {' '}
       <h1 className={styles.buy_stock}>  enter the number of stock you have to buy</h1>
<div className={styles.num}>
       ...
       <div className={styles.total}>
        <h1 className={styles.total_text}>Total Price:</h1>
